   ...
   $(document).on("click", ".ongoing-btn", function () {
    ...
    function savetasktolocalstorage(){
        ...
        $("#todotext p").each(function(index){
            ...
            if (Completed === true && endTime === null) {
                 endTime = moment().format('hh:mm:ss A');
            }
            
            let duration = Duration($(this).data("starttimer"), $(this).data("endTime"));
...
//    ......................... FOR LOAD TASK WHEN PAGE LOAD..........................
    ...
    function stopwatch(element, starttimer) {
        let timeout = setTimeout(function () {
             if (starttimer) {
                  ...
                  if (element.closest("p").find('.ongoing-btn').css("background-color") === "rgb(255, 165, 0)") {
    ...
    function Duration(starttimer, endTime) {
